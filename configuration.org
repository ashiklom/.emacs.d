...
(defhydra ans/buffer-window-hydra (:exit t :hint nil)
  ...
  ("w" (lambda () (interactive) (bury-buffer (current-buffer)) (evil-window-delete)))
...
(use-package shackle
  ...
  (setq shackle-rules '((compilation-mode :noselect t)
                        ("*R*'" :regexp t :noselect t :align ans/align-if-wide-enough :size 0.4)))
  (shackle-mode))
...
Unless called with prefix argument ARG, also delete the namespace from the current call."
  ...
  (let* ((addition (ans/import/split-pkg-fun-call (ans/import/R-pkg-fun-word-at-point))))
    ...
    (when (= (length addition) 2)
      ...
      (unless arg (ans/import/R-pkg-delete-namespace))
...
(defun ans/import/source-imports ()
  ...
  (interactive)
  (let* ((start-end (ans/import/find-import-lists))
