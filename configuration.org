...
#+BEGIN_SRC emacs-lisp
  ...
  Switch:  _h__j__k__l_    Move: _H__J__K__L_    Misc: _r_evert   _s_ave as   _z_:undo   _Z_:redo"
    ("w" quit-window)
    ("W" kill-this-buffer)
    ("d" delete-window)
...
#+BEGIN_SRC emacs-lisp
  (setq org-clock-clocktable-default-properties
        '(:maxlevel 4 :scope agenda :block today))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defhydra ans/clock-hydra (:exit t)
    ...
    ("h" (lambda () (interactive) (org-clock-in-last 4)) "Clock from history")
    ("T" org-clock-report "Insert clock report"))
#+END_SRC
