...
- [[#keybindings][Keybindings]]
  ...
  - [[#evil-extensions][Evil extensions]]
    ...
    - [[#evil-indent-textobject][evil-indent-textobject]]
    ...
    - [[#evil-org][evil-org]]
    - [[#evil-latex-textobjects][evil-latex-textobjects]]
...
- [[#company][Company]]
  ...
  - [[#custom-backends][Custom backends]]
    - [[#complete-inside-directory-or-projectile-project][Complete inside directory or projectile project]]
...
- [[#org-mode][Org-mode]]
  ...
  - [[#default-to-do-keywords][Default to-do keywords]]
  - [[#formatting-and-aesthetics][Formatting and aesthetics]]
  - [[#source-code-babel][Source code (babel)]]
  - [[#refile][Refile]]
  - [[#clocking][Clocking]]
  - [[#custom-structure-templates][Custom structure templates]]
  - [[#keybindings-1][Keybindings]]
  - [[#other-custom-functions][Other custom functions]]
...
#+BEGIN_SRC emacs-lisp
  (use-package lispyville
    :ensure t
    :hook ((lisp-mode emacs-lisp-mode) . lispyville-mode))
#+END_SRC
