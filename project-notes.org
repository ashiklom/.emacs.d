...
* Configuration to-do list [38/99]                                   ::emacs:
** DONE Line numbers
...
** TODO Overview of unread Slack messages by team              ::emacs:slack:
   Will probably have to write my own function, but should be mostly possible using functions from the slack package.
** TODO C-n/C-p completion should work in plain text buffers ::completion:emacs:
** TODO Fix leftover cursor line when switching evil modes       ::emacs:bug:
